...
let contadorPrimeiro = calculaTempo(tempoObjetivo2)
contador[1].textContent = faltam ${contadorPrimeiro[0]} dias, ${contadorPrimeiro[1]} horas, ${contadorPrimeiro[2]} minutos, ${contadorPrimeiro[3]} segundos
